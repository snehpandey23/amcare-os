...
| Explore follow-up pricing | `/pricing` | secondary-other | main | 2 | `/adhd-care` | **REMOVE** |
...
| View profile | `/providers/dr-swati-pandey` | secondary-service | main | 1 | `/` | **REMOVE** |
...
| Explore Telehealth Care | `/adhd-care` | secondary-service | main | 1 | `/` | **REMOVE** |
...
| View profile | `/providers/dr-vanessa-urbina` | secondary-service | main | 1 | `/about` | **CONSOLIDATE** (secondary) |
| View profile | `/providers/dr-natasha-desai` | secondary-service | main | 1 | `/about` | **CONSOLIDATE** (secondary) |
| View profile | `/providers/dr-swati-pandey` | secondary-service | main | 1 | `/about` | **CONSOLIDATE** (secondary) |
| View profile | `/providers/megan-wunderlich` | secondary-service | main | 1 | `/about` | **CONSOLIDATE** (secondary) |
...
|------|----------:|----------------:|-----------------|
| `/` | 15 | 1 | Talk to a Clinician; See pricing; Free screening →; Free ADHD screening… |
| `/about` | 12 | 3 | View Dr. Pandey's Profile |
| `/providers` | 9 | 1 | — |
...
| View profile | `/providers/dr-swati-pandey` | 1 | Secondary explore link outside hero/final band |
...
| Explore Telehealth Care | `/adhd-care` | 1 | Secondary explore link outside hero/final band |
