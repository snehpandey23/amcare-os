...
| ---------------------------- | --------------------------------------------- | ------------------------------------------------------------ | ------ | ----- | ----- |
| Homepage                     | Start Secure Medical Chat works               | Opens secure chat / correct redirect                         | TBD    |       |       |
...
| Blog                         | Weight/metabolic blog CTA links work          | Opens secure chat / relevant service page                    | TBD    |       |       |
...
| Pricing page                 | Start Secure Medical Chat works               | Opens secure chat / correct redirect                         | TBD    |       |       |
...
| Tracking                     | CTA click visible                             | CTA event appears in GA4/GTM if configured                   | TBD    |       |       |
