...
/** Social column — hub page + live accounts (in addition to Policies / Terms). */
const FOOTER_SOCIAL_LINKS = [
  { href: '/social', label: 'Community & video' },
  {
    href: 'https://www.facebook.com/siyahealthofficial',
    label: 'Facebook',
    external: true,
  },
  {
    href: 'https://www.instagram.com/siyahealth_official/',
    label: 'Instagram',
    external: true,
  },
  {
    href: 'https://www.linkedin.com/company/siyahealthofficial/',
    label: 'LinkedIn',
    external: true,
  },
  {
    href: 'https://www.pinterest.com/SiyahealthUS/',
    label: 'Pinterest',
    external: true,
  },
  {
    href: 'https://x.com/Siyahealth_tips',
    label: 'X',
    external: true,
  },
  {
    href: 'https://www.youtube.com/@siya.health',
    label: 'YouTube',
    external: true,
  },
];
...
const FOOTER_SOCIAL_BLOCK = `          <div class="footer-social">
            ...
            <a href="https://x.com/Siyahealth_tips" target="_blank" rel="noopener" aria-label="X"><svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg></a>
            <a href="https://www.youtube.com/@siya.health" target="_blank" rel="noopener" aria-label="YouTube"><svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg></a>
          </div>`;
...
function renderSeoFooterColumns(relPath = '') {
  const showScreening =
    ...
    /^adhd-care\//i.test(relPath) ||
    /^adult-adhd/i.test(relPath) ||
    /^adhd-/i.test(relPath) ||
    /adhd/i.test(relPath);
  const careLinks = showScreening
    ? FOOTER_CARE_SERVICES_LINKS
    : FOOTER_CARE_SERVICES_LINKS.filter((l) => l.href !== '/adhd-screening');
  return [
    renderFooterLinkColumn('Care &amp; Services', careLinks, 'footer-col footer-col--services'),
