...
height="0" width="0" style="display:none;visibility:hidden" title="GTM"></iframe></noscript>
    ...
    <header class="site-header">
      <div class="container">
        ...
        <div class="nav-cta">
          <a class="button ds-button ds-button--primary" href="/primary-care" data-siya-track="explore-care-click" data-siya-location="nav">Primary Care</a>
        </div>
      </div>
    </header>
    <main id="main">
...
${post.bodyHtml}
            ...
            <section class="blog-provider-cta" aria-labelledby="supporting-cta-heading">
              ...
              <p>These guides orient you—they do not diagnose. A licensed clinician can sort look-alikes and decide whether labs or further evaluation fit your story.</p>
