 ...
 *
 * HARD RULE: this script writes ONLY adult-adhd-california.html (SEO hub, full nav).
 * Google Ads evaluation LP lives at /adhd-evaluation-california and is generated by
 * generate-adhd-evaluation-california.mjs. Never write the ads LP onto this path.
 *
...
const ADS_LP_FORBIDDEN = path.join(ROOT, 'adhd-evaluation-california.html');
if (path.resolve(OUT) === path.resolve(ADS_LP_FORBIDDEN)) {
  throw new Error('Cornerstone generator must never target the ads evaluation LP path.');
}
