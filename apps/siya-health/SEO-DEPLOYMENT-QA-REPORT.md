...
Generated: 2026-06-03T13:45:07.657Z

## Summary

| Metric | Value |
|--------|------:|
| HTML pages scanned | 144 |
| Sitemap URLs | 144 |
| Pages with Meet & Greet in nav | 116 |
...
- **Default primary CTA:** Book a Meet & Greet → `https://link.yourmarketingai.com/widget/form/mnWpgh0IEgFvJymdZqHY`
...
### Non-ADHD pages still containing `adhd-screening` (0)

_None detected._

### All pages with any `adhd-screening` reference (54)
...
_…and 14 more (expected on ADHD funnels)._
