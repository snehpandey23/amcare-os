...
export const GENERATED_WORKSPACE_KB: WorkspaceKbEntry[] = [
  ...
  {
    "id": "vma-day-to-day-tasks-provisional",
    "category": "clinical_operations",
    "title": "Virtual medical assistant — day-to-day tasks (provisional)",
    "keywords": [
    ...
    "body": "**Provisional** checklist of day-to-day **virtual medical assistant** tasks. Pasted from a landing page. **May not be accurate.** Not a signed SOP. Do not cancel visits, clear invoices, or give clinical advice from Ask. When this list and a **live** topic disagree, use the live topic and ask the **Clinical Program Manager**. Staff asked what a VMA does day to day. This file holds the pasted list so Ask can point at it without inventing a handbook. Named helper docs were not supplied. Work the list as written, then confirm anything that conflicts with a live guide. Keep names, chart numbers, and message text out of Ask. 1. Check all appointments on the calendar for payment. Cancel unpaid ones under the stated **24-hour policy**. 2. Message cancelled appointments to clear the invoice and reschedule when that applies. 3. Check all appointments for form completion. 4. Send a form-completion message when that applies. 5. Complete precharting in chronological order for scheduled patients. 6. Check patient chats for the **past 48 hours** and make sure queries are resolved. 7. Check and resolve all faxes. 8. Check appointments for the **past 48 hours**. Confirm notes are locked and status/time are saved. 9. Send forms, create invoices, and book appointments as instructed, in order, within **30 minutes**. 10. Address patient-support messages and resolve them within **24 hours**. 11. Call existing patients for re-engagement when identified and instructed. 12. Create a spreadsheet for the patient database in **TX** and **PA**. 13. Maintain and provide daily, weekly, and monthly reports: appointment number, type, and state; insights; last visit; controlled vs non-controlled. 14. Track feedback and complaints in a separate spreadsheet (reputation). 15. Answer patient calls and inform providers when needed. 16. Maintain a database of standard messages to send to patients. 17. Answer practice calls during working hours. Call patients for follow-up when instructed. 18. Review the task platform every **30 minutes**. Complete pending tasks, then hide finished rows so only pending work stays in view. **Helper names from the paste — URLs were not provided. Do not invent them:** Messages doc · Appointment links · Spreadsheets. **Is this the official MA handbook?** No. Landing-page copy, filed provisional until Clinical Program confirms it. **Where are the Messages doc, appointment links, and spreadsheets?** Not in this paste. Ask the Clinical Program Manager. Do not guess links in chat. **Can Ask cancel an unpaid visit or draft the patient message?** No. This chat does not take those actions. | Symptom | Action | |---------|--------| | A step here conflicts with a live SOP | Follow the live topic. Tell Clinical Program Manager. | | Helper doc link is missing | Do not invent a URL. Ask Clinical Program Manager. | | Task looks clinical (meds, symptoms, controlled substance decision) | Do not decide in Ask. Inform the provider / Clinical Program Manager. | Use when staff ask what a virtual medical assistant does day to day, or about this calendar / forms / prechart / fax / notes / calls / TX-PA report checklist. Always say it is provisional and may be inaccurate. Never invent Messages doc, appointment, or spreadsheet URLs. Never cancel appointments, clear invoices, or write chart notes from chat. If a live topic covers the same step, prefer the live topic. Escalate mismatches to the Clinical Program Manager.",
    "escalate": "Clinical Program Manager",
    "answerTrust": "provisional"
  },
  {
    ...
    "body": "When a patient reports **emergency or red-flag symptoms** (chest pain, can’t breathe, stroke/heart-attack language, suicidal ideation, or anything that sounds **life-threatening**), Medical Assistants give a **safety redirect** and **escalate to a licensed clinician** — they do **not** diagnose, triage severity as a clinician, or keep the patient waiting on portal chat. Siya Assist and MA chat are **not** emergency care. Soft-stopping with “no staff guide” leaves staff without the approved workflow. This topic is the **internal** playbook for what to say and who to loop in. 1. **Treat it as urgent** — do not continue a routine FAQ, billing, or scheduling thread. 2. **Tell the patient clearly (approved wording):** - *“If this feels urgent and you can’t wait for a doctor’s reply, please go to urgent care or the ER, or call 911.”* - If they are in **immediate danger**: *“Please call 911 (or your local emergency number) now.”* 3. **Do not** give medical advice, dosing, “is this a heart attack?”, anxiety coaching, or promises that a provider will reply in minutes. 4. **Escalate to the provider / clinical lead immediately** (same channel you use for clinical portal messages — see chat-review SLA). Flag **emergency / red-flag**. 5. **Document** in the approved clinical system (time, channel, what the patient said, what you told them, who you escalated to) — **no PHI in Ask**. 6. If the interaction is **live on phone** and they may be unstable: stay calm, repeat the 911 / ER redirect, loop a clinician/supervisor, and do not hang up abruptly while they are seeking help instructions. ### Chest pain + anxiety (common ask) Patients often pair **chest pain** with **anxiety**. Staff still use the **same emergency redirect** — MAs do **not** decide “it’s only anxiety.” Calm empathy is fine; clinical reassurance is not. **Example staff line:** *“I’m sorry you’re feeling this way. I can’t assess chest pain over chat. If it feels urgent or you’re worried you can’t wait, please call 911 or go to the ER / urgent care now. I’m also alerting the clinical team right away.”* **Where is the protocol?** This guide + **Patient portal chat — response SLAs** (clinical → provider immediately). There is no separate “diagnose chest pain” SOP for MAs — by design. **What if they’re already in the ER?** Thank them, stop clinical Q&A, escalate to provider for chart continuity, document. **What if it’s only mild anxiety and they deny emergency?** Still avoid diagnosing. Offer routine scheduling / provider message path **and** keep escalate-if-worse / 911 language available if symptoms worsen. | Situation | Action | |-----------|--------| | Chest pain, SOB, stroke/HA language, life-threatening | 911/ER/urgent care script + provider immediate | | Suicidality / self-harm | 911 / local emergency + provider immediate (same urgency) | | Unsure if clinical | Escalate provider — do not guess | | Staff asked Ask for a script | Use this topic; do not invent treatment advice | Answer with **workflow + approved patient lines** only. Never invent clinical triage. Prefer this topic over hostile/abusive-patient SOP when the ask is emergency symptoms. Cite chat-review SLA for escalation timing.",
